...
namespace EindCase.Api
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IStringToCourseConvertService, StringToCourseConvertService>();
            services.AddScoped<ICourseInsertService, CourseInsertService>();
